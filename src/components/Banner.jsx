        ...
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-36">
          <div className="space-y-8">
            ...
            <p className="text-sm md:text-xl">
              ...
              pariatur corporis at veniam est voluptas animi!aaa
            </p>
            <label class=" px-3 py-2 border rounded-md flex items-center gap-2">
              <input type="text" class="grow outline-none rounded-md px-1 dark:bg-slate-900 dark:text-white" placeholder="Search" fdprocessedid="5dtnd" autocomplete="off" />
